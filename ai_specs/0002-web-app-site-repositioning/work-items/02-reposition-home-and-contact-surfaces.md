...
- [x] Il blocco Magazzino della Hero usa il copy canonico e tutti i sei ID della matrice senza aggiungere claim non approvati.
...
- [x] Test di rendering coprono H1, copy hero, quattro pilastri, matrice Magazzino, rimozione delle sezioni legacy, CTA, FAQ/FAQPage e immagine responsive con alt neutro.
